...
void Led::turnOn(uint8_t led) {
    switch (led) {
    case 0: PORTA.OUT |= RED; PORTA.OUT &= ~GREEN; PORTA.OUT &= ~BLUE; break;
    case 1: PORTA.OUT |= GREEN; PORTA.OUT &= ~RED; PORTA.OUT &= ~BLUE; break;
    case 2: PORTA.OUT |= BLUE; PORTA.OUT &= ~RED; PORTA.OUT &= ~GREEN; break;

    case 3: PORTA.OUT |= RED; PORTA.OUT |= BLUE; PORTA.OUT &= ~GREEN; break;      // Liga o LED na cor roxo
    case 4: PORTA.OUT |= RED; PORTA.OUT |= GREEN; PORTA.OUT &= ~BLUE; break;      // Liga o LED na cor amarela
    case 5: 
            PORTA.OUT |= RED; 
            PORTA.OUT |= GREEN; 
            PORTA.OUT |= BLUE;
